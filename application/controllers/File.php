...
class File extends MY_Controller {
    ...
    public function getdocument($file_path, $mime_type = 'image/jpeg'){
        ...
        //$file_system_path = "home".DIRECTORY_SEPARATOR."ozul6s4w8s9l".DIRECTORY_SEPARATOR."public_html".DIRECTORY_SEPARATOR."DIEZKA".DIRECTORY_SEPARATOR."application".DIRECTORY_SEPARATOR."images".DIRECTORY_SEPARATOR.$filename;
